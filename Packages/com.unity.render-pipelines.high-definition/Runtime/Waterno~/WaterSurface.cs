...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public class WaterSurface : MonoBehaviour
    {
        ...
        public void OpenMediumFileDialog(){
        }

        public void SetMediumPath(string path) {
          mediumSpectralCoefsPath = path;
          LoadSpectralData();
        }

        public void SetCameraPath(string path) {
          cameraResponseCurvePath = path;
          LoadSpectralData();
        }
        ...
        private void LoadSpectralData() {
            ...
            // UpdateRefractionColor();


        }

        private void UpdateRefractionColor() {
            refractionColor = spectralData.GetRefractionColor();

            scatteringColor = spectralData.GetScatteringColor();
            Debug.Log("New refraction color: " + refractionColor);
        }
